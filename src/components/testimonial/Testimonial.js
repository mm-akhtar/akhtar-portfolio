...
const clients = [
	{
		...
		type: (
			<>
				Client <Icon icon='twemoji:flag-germany' fontSize={'18px'} style={{marginLeft: '2px', marginBottom: '-4px'}} />
			</>
		),
		review:
	...
	},
	{
		...
		type: (
			<>
				Client <Icon icon='twemoji:flag-belgium' fontSize={'18px'} style={{marginLeft: '2px', marginBottom: '-4px'}} />
			</>
		),
		review:
	...
	},
	{
		...
		type: (
			<>
				Client <Icon icon='emojione-v1:flag-for-serbia' fontSize={'18px'} style={{marginLeft: '2px', marginBottom: '-4px'}} />
			</>
		),
		review:
	...
	},
	{
		...
		type: (
			<>
				Client <Icon icon='twemoji:flag-us-outlying-islands' fontSize={'18px'} style={{marginLeft: '2px', marginBottom: '-4px'}} />
			</>
		),
		review: 'I wholeheartedly recommend this seller with a perfect 10/10 rating. The experience was exceptional and exceeded my expectations. I look forward to working with them again in the future.',
	},
	{
		name: 'PGW',
		...
		type: (
			<>
				Client <Icon icon='twemoji:flag-pakistan' fontSize={'18px'} style={{marginLeft: '2px', marginBottom: '-4px'}} />
			</>
		),
		review:
	...
	},
	{
		...
		type: (
			<>
				Client <Icon icon='twemoji:flag-netherlands' fontSize={'18px'} style={{marginLeft: '2px', marginBottom: '-4px'}} />
			</>
		),
		review:
	...
	},
	{
		...
		review: 'Great work. This is my second order and I am happy. He is always helpful and communicates effectively. This is important when searching for gig fulfillment on Fiverr.',
	},
	{
		name: 'Sean James',
